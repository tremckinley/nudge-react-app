    ...
    return (
        <div className="flex flex-col items-center justify-center my-2">
            <div className="text-2xl mb-2 ">
                ...
                <button><i className={"fa-solid mt-2 text-2xl " + (paused ? "fa-play" : "fa-pause")} title="Pause" onClick={() => handlePause()}></i></button>
                <button><i className="fa-solid fa-forward-step mr-2 ml-4" title="Go Forward 1" onClick={() => handleRightClick()}></i></button>
                <button><i className="fa-solid fa-forward-fast" title="Go Forward 3" onClick={() => handleRightClick(true)}></i></button>
            </div>
            <hr></hr>
