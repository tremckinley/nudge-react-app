...
export default function FlashCardContainer(props) {
    ...
    return (
        <div className="flex flex-col items-center justify-center my-2">
            <div className="text-2xl text-indigo-900 mb-2">
                <button className="border p-1 rounded-lg bg-indigo-200"><i className="fa-solid fa-backward-fast" title="Go Back 3" onClick={() => handleLeftClick(true)}></i></button>
                <button><i className="fa-solid fa-backward-step ml-2 mr-4" title="Go Back 1" onClick={() => handleLeftClick()}></i></button>
                <button><i className={"fa-solid mt-2 text-2xl " + (paused ? "text-blue-400 fa-play" : "text-[indigo] fa-pause")} onClick={() => handlePause()}></i></button>
